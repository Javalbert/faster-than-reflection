...
public final class ClassAccessFactory<T> {
	...
	private void visitClassAccessMethods() {
		...
		visitGeneralFieldAccessSetterBridge();
	}
	...
	private void visitFieldAccessGetter(FieldAccessInfo fieldAccessInfo) {
		mv = cw.visitMethod(
				ACC_PUBLIC,
	...
	private void visitGeneralFieldAccessSetterBridge() {
